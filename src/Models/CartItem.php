...
namespace Mykholy\ShoppingCart\Models;
 ...
 * @property-read \Mykholy\ShoppingCart\Buyable $buyable
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem query()
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem whereBuyableId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem whereBuyableType($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem whereCartId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem whereQuantity($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Mykholy\ShoppingCart\Models\CartItem whereUpdatedAt($value)
 * @mixin \Eloquent
 */
